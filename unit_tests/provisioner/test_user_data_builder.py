...
def test_user_data_builder_generates_valid_yaml_from_single_user_data_object():
    ...
    assert user_data_object_1.script in script_file["content"]
...
def test_user_data_can_merge_user_data_objects_yaml():
    ...
    assert user_data_object_1.script in script_files[0]["content"]
    assert user_data_object_2.script in script_files[1]["content"]
